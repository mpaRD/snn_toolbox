...
def get_dataset(config):
    ...
    is_testset_needed = any([config.getboolean('tools', 'evaluate_ann'), config.getboolean('tools', 'simulate'), config.getboolean('loihi', 'normalize_thresholds', fallback=False)])
